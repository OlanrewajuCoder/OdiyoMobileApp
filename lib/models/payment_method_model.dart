class PaymentMethodsList {
  ...
  PaymentMethodsList.fromJson(Map<String, dynamic> json) {
    paymentMethods = json['paymentMethods'] != null ? PaymentMethods.fromJson(json['paymentMethods']) : null;
  }
...
class Card {
  ...
  Card.fromJson(Map<String, dynamic> json) {
    ...
    threeDSecureUsage = json['three_d_secure_usage'] != null ? ThreeDSecureUsage.fromJson(json['three_d_secure_usage']) : null;
    wallet = json['wallet'];
  }
